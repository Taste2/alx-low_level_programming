...
Security
Insights
alx-low_level_programming/0x0F-function_pointers/README.md
@Khobbytubz
Khobbytubz function that prints a name
 1 contributor
78 lines (73 sloc)  4.3 KB
C - Function pointers

TASK 0 - Write a function that prints a name. Prototype: void print_name(char *name, void (*f)(char *));

TASK 1 - Write a function that executes a function given as a parameter on each element of an array. Prototype: void array_iterator(int *array, size_t size, void (*action)(int)); where size is the size of the array and action is a pointer to the function you need to use
